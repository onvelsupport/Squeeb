...
path(
    "squeeb-admin/", squeeb_admin_dashboard,
    name="squeeb_admin_dashboard",
),

path(
    "squeeb-admin/campaigns/", admin_campaigns,
    name="admin_campaigns",
),

path(
    "squeeb-admin/campaigns/create/", admin_create_campaign_page,
...
path(
    "api/campaign/<int:campaign_id>/", get_campaign,
    name="get_campaign",
),

path(
    "api/campaign/<int:campaign_id>/submit/", submit_campaign,
